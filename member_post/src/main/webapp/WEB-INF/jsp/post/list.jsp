        ...
        <main class="container">
            <div class="clearfix py-3 mt-3">
                ...
                <ul class="pagination justify-content-center my-5">
     				...
     				<li class="page-item"><a class="page-link" href="list?page=${pageDto.startPage-1}&${pageDto.cri.qs}&category=${pageDto.cri.category}"><i class="fa-solid fa-angles-left"></i></a></li>
     				</c:if>
