    ...
    <div class="wrap">
        <header class="container-fluid">
            <div class="container clearfix p-2">
                <a href="index.html" class="float-start"><img src="images/logo.png" alt="로고" class="img-fluid" width="250"></a>
        ...
        <main class="container">
            ...
            <form name="frm" class="mx-auto col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4 col-xxl-3 card p-2 mt-5">
                 ...
                 <input type="text" class="form-control my-2" id="name" placeholder="상세주소" name="name">
        ...
        <footer class="mt-5 bg-warning text-center p-3">
